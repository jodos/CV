...
\begin{itemize}
	...
	\item[] Reprise du projet et analyse de l'application $\cdot$ Gestion et automatisation de production de l'application avec Maven $\cdot$ Optimisations de l'interface Web $\cdot$ Amélioration des temps de réponse, mise en place d'un cache $\cdot$ Statistiques (SQL) sur l'utilisation des machines, nécessaires lors de la phase de planification des chantiers $\cdot$ Personne de contact pour les aspects techniques et métiers
